...
SELECT DISTINCT nome_cliente,nome_agencia FROM deposito WHERE nome_agencia='PUC'  
intersect 
SELECT DISTINCT nome_cliente,nome_agencia FROM emprestimo WHERE nome_agencia='PUC';
...
FROM deposito where nome_agencia='Pampulha' GROUP BY nome_cliente, nome_agencia ;
